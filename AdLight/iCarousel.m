...
{
    iCarousel *carousel = (__bridge iCarousel *)(context);
...
- (void)depthSortViews
{
    ...
    for (UIView *view in [[itemViews allValues] sortedArrayUsingFunction:compareViewDepth context:(__bridge void *)(self)])
    {
